    ...
    setTimeout(() => {
      try {
        ...
        if (
          ...
          setFieldError("password", t("validation.login.invalidCredentials"));
          setSubmitting(false);
          return;
        }
        ...
        setFieldError("password", t("validation.login.failed"));
      } finally {
        setSubmitting(false);
      }
    }, 1000);
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalDialog}>
        ...
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>{t("login.title")}</h2>
        </div>
